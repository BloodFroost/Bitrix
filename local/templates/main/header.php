...
<head>
    ...
    <link rel="stylesheet" href="/local/templates/.default/js/fancybox/jquery.fancybox-1.3.4.css" />
    ...
    <div class="wrap">
        ...
        <div class="rw_reviewed">
            <div class="rw_slider">
                ...
                <div id="rwprev"></div>
                <div id="rwnext"></div>
                <a href="/company/otzyvy/index.php" class="rw_allreviewed">Все отзывы</a>
            </div>
        </div>